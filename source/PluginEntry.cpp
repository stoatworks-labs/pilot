/**
    ...
    `CFFGLPluginInfo` that Pilot.cpp registers at static-initialisation time.
    ...
    binary: which build it is.
        ...
        strings Pilot.bundle/Contents/MacOS/Pilot | grep pilot
*/

extern "C" const char* PilotBuildStamp()
{
	return "pilot " PILOT_VERSION " built " __DATE__ " " __TIME__;
}
